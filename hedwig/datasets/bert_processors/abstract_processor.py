...
def convert_examples_to_features(examples, max_seq_length, tokenizer, print_examples=False):
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        print("printing example.label:", example.label, type(example.label))

        label_id = float(example.label) #[float(x) for x in example.label]

        print("abstract label id: ", label_id)
