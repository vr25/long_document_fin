...
class BertTrainer(object):
    def __init__(self, model, optimizer, processor, scheduler, tokenizer, args):
        ...
        self.log_header = 'Epoch Iteration Progress   Dev/Loss   Dev/mse'
        self.log_template = ' '.join('{:>5.0f},{:>9.0f},{:>6.0f}/{:<5.0f}, {:10.4f}, {:10.4f}'.split(','))

        self.iterations, self.nb_tr_steps, self.tr_loss = 0, 0, 0
        self.best_dev_loss, self.unimproved_iters = 0, 0
    ...
    def train_epoch(self, train_dataloader):
        for step, batch in enumerate(tqdm(train_dataloader, desc="Training")):
            ...
            if self.args.is_multilabel:
                ...
                loss = F.mse_loss(logits, label_ids)
    ...
    def train(self):
        ...
        label_ids = torch.tensor([f.label_id for f in train_features], dtype=torch.float) #long)
        ...
        for epoch in trange(int(self.args.epochs), desc="Epoch"):
            ...
            dev_loss, dev_mse = dev_evaluator.get_scores()[0]
            ...
            if dev_loss > self.best_dev_loss:
                ...
                if self.unimproved_iters >= self.args.patience:
                    ...
                    tqdm.write("Early Stopping. Epoch: {}, Best Dev F1: {}".format(epoch, self.best_dev_loss))
                    break
