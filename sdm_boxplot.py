...
mean_, std_, min_, max_ = data_stats(x)
print("Before data stats (mean/std/min/max): %.5f, %.5f, %.5f, %.5f"%(mean_, std_, min_, max_))
...
mean_, std_, min_, max_ = data_stats(x)
print("After data stats (mean/std/min/max): %.5f, %.5f, %.5f, %.5f"%(mean_, std_, min_, max_))
...
plt.title('distribution of ROA', fontsize=15)
# Save the figure
